...
`,
  ...
  },
  {
    ...
    title: "AWS Projects",
    subTitle: "AWS Projects showcase",
    stack: [
      "AWS",
      "EC2",
      "S3",
    ...
    description: `This collection of AWS projects demonstrates practical applications of Amazon Web Services in various domains. Each project showcases the use of different AWS services such as EC2 for scalable computing, S3 for secure storage, Lambda for serverless computing, DynamoDB for NoSQL database management, and CloudFormation for infrastructure as code. These projects highlight the versatility and power of AWS in building robust and scalable cloud-based solutions.`,
    date: "Jan , 2026",
    github: "https://github.com/fredymorara/AWS-Set-Up-An-AWS-Account",
    live: "https://learn.nextwork.org/determined_lavender_smart_antelope/docs/aws-networks-private",
    color: "#ffffff",
