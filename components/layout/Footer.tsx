  ...
  return (
    <footer className="relative border-t border-white/10 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-32 flex flex-col gap-20">
                ...
                <li key={socialLink.id}>
                  ...
                  >
                    ...
                    <img
                      src={socialLink.icon}
                      alt={socialLink.alt}
                      className="h-5 w-5 opacity-70 transition-all duration-500 group-hover:invert group-hover:opacity-100"
                    />
                  </Link>
                </li>
              ))}
        ...
        {/* Bottom Split */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-white/5 text-sm text-white/30">
