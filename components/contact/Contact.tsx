          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center gap-4 bg-white/5 border-l border-white/10 relative z-10">
            {contacts.map((contact) => (
              <Link 
                ...
                href={contact.path} 
                target="_blank"
                className="group flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl bg-card-bg border border-white/10 p-6 transition-all duration-500 hover:border-accent-sunset-end/30 hover:shadow-[0_4px_30px_rgba(221,36,118,0.1)] hover:-translate-y-1"
              >
                <div className="flex items-center gap-6">
                  <div className="flex shrink-0 h-14 w-14 items-center justify-center rounded-full bg-white/5 border border-white/10 transition-transform duration-500 group-hover:scale-110 group-hover:border-accent-sunset-start/30">
